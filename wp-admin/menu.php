...
$menu[5] = array( __('Artículos'), 'edit_posts', 'edit.php', '', 'open-if-no-js menu-top menu-icon-post', 'menu-posts', 'none' );
	$submenu['edit.php'][5]  = array( __('Todos los Artículos'), 'edit_posts', 'edit.php' );
	/* translators: add new post */
	$submenu['edit.php'][10]  = array( _x('Añadir Nuevo Artículo', 'post'), get_post_type_object( 'post' )->cap->create_posts, 'post-new.php' );
