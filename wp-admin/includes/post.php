...
function _wp_post_thumbnail_html( $thumbnail_id = null, $post = null ) {
	...
	$set_thumbnail_link = '<p class="hide-if-no-js"><a title="' . esc_attr__( 'Asignar Imagen para la portada' ) . '" href="%s" id="set-post-thumbnail" class="thickbox">%s</a></p>';
	$content = sprintf( $set_thumbnail_link, $upload_iframe_src, esc_html__( 'Asignar Imagen para la portada' ) );
