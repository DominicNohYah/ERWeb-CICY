...
class Woothemes_Testimonials {
	...
	public function register_post_type () {
		$labels = array(
			'name' => _x( 'Investigadores', 'post type general name', 'woothemes-testimonials' ),
		'singular_name' => _x( 'Investigador', 'post type singular name', 'woothemes-testimonials' ),
			'add_new' => _x( 'Añadir Investigador', 'testimonial', 'woothemes-testimonials' ),
			'add_new_item' => sprintf( __( 'Añadir Investigador', 'woothemes-testimonials' ), __( 'Testimonial', 'woothemes-testimonials' ) ),
			'edit_item' => sprintf( __( 'Editar Investigador', 'woothemes-testimonials' ), __( 'Testimonial', 'woothemes-testimonials' ) ),
			'new_item' => sprintf( __( 'Nuevo Investigador', 'woothemes-testimonials' ), __( 'Testimonial', 'woothemes-testimonials' ) ),
			'all_items' => sprintf( __( 'Investigadores', 'woothemes-testimonials' ), __( 'Testimonials', 'woothemes-testimonials' ) ),
			'view_item' => sprintf( __( 'Ver Investigador', 'woothemes-testimonials' ), __( 'Testimonial', 'woothemes-testimonials' ) ),
			'search_items' => sprintf( __( 'Bucar Investigador', 'woothemes-testimonials' ), __( 'Testimonials', 'woothemes-testimonials' ) ),
			'not_found' =>  sprintf( __( 'No se encontro Investigadores', 'woothemes-testimonials' ), __( 'Testimonials', 'woothemes-testimonials' ) ),
			'not_found_in_trash' => sprintf( __( 'No se encontro, está eliminado', 'woothemes-testimonials' ), __( 'Testimonials', 'woothemes-testimonials' ) ),
			'parent_item_colon' => '',
			'menu_name' => __( 'Investigadores', 'woothemes-testimonials' )
		...
		$args = array(
			...
			'show_in_menu' => true,
			'query_var' => true,
			'rewrite' => array( 'slug' => 'Investigador' ),
			'capability_type' => 'post',
			'has_archive' => 'Investigadores',
			'hierarchical' => false,
	...
	public function updated_messages ( $messages ) {
	  ...
	  $messages[$this->token] = array(
	    ...
	    1 => sprintf( __( 'Datos del Investigador actualizados. %sVer Investigador', 'woothemes-testimonials' ), '<a href="' . esc_url( get_permalink( $post_ID ) ) . '">', '</a>' ),
	...
	public function meta_box_setup () {
		//add_meta_box( 'testimonial-data', __( 'Datos Investigdor', 'woothemes-testimonials' ), array( &$this, 'meta_box_content' ), $this->token, 'normal', 'high' );
	}
	...
	public function enter_title_here ( $title ) {
		if ( get_post_type() == $this->token ) {
			$title = __( 'Nombre de Investigador', 'woothemes-testimonials' );
		}
		return $title;
